...
namespace Pathfinding {
	...
	public abstract class GridNodeBase : GraphNode {
		...
		private const int GridFlagsWalkableErosionMask = 1 << GridFlagsWalkableErosionOffset;

		private const int GridFlagsWalkableTmpOffset = 9;
		private const int GridFlagsWalkableTmpMask = 1 << GridFlagsWalkableTmpOffset;
