...
namespace Pathfinding {
	...
	public class RaycastModifier : MonoModifier {
		...
		private static readonly int[] iterationsByQuality = new [] { 1, 2, 1, 3 };
		...
		private List<Vector3> ApplyGreedy (Path p, List<Vector3> points, System.Func<GraphNode, bool> filter, NNConstraint nnConstraint) {
		...
		private List<Vector3> ApplyDP (Path p, List<Vector3> points, System.Func<GraphNode, bool> filter, NNConstraint nnConstraint) {
