...
namespace Pathfinding {
	...
	public class HierarchicalGraph {
		...
		private const int MaxChildrenPerNode = Tiling * Tiling;
		private const int MinChildrenPerNode = MaxChildrenPerNode/2;
		...
		private System.Action<GraphNode> connectionCallback;

		private Queue<GraphNode> temporaryQueue = new Queue<GraphNode>();
		private List<GraphNode> currentChildren = null;
		private List<int> currentConnections = null;
