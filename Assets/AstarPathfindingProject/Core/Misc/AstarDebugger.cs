...
namespace Pathfinding {
	...
	public class AstarDebugger : VersionedMonoBehaviour {
		...
		private int maxVecPool = 0;
		private int maxNodePool = 0;

		private PathTypeDebug[] debugTypes = new PathTypeDebug[] {
		...
		private struct PathTypeDebug {
			private string name;
			private System.Func<int> getSize;
			private System.Func<int> getTotalCreated;
