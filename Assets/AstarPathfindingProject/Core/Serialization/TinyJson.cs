...
namespace Pathfinding.Serialization {
	...
	public class TinyJsonSerializer {
		...
		private Dictionary<Type, Action<System.Object> > serializers = new Dictionary<Type, Action<object> >();
		...
		private void Serialize (System.Object obj) {
			if (obj == null) {
				output.Append("null");
				return;
			}
	...
	public class TinyJsonDeserializer {
		...
		private static readonly System.Globalization.NumberFormatInfo numberFormat = System.Globalization.NumberFormatInfo.InvariantInfo;
		...
		/// Will load all fields into the populate object if it is set (only works for classes).
		/// </summary>
		private System.Object Deserialize (Type tp, System.Object populate = null) {
