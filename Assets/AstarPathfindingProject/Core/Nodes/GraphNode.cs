...
namespace Pathfinding {
	...
	public abstract class GraphNode {
		...
		private const int NodeIndexMask = 0xFFFFFFF;
		private const int DestroyedNodeIndex = NodeIndexMask - 1;
		private const int TemporaryFlag1Mask = 0x10000000;
		private const int TemporaryFlag2Mask = 0x20000000;
		...
		private const uint FlagsWalkableMask = 1 << FlagsWalkableOffset;
		...
		private const uint HierarchicalIndexMask = (131072-1) << FlagsHierarchicalIndexOffset;
		...
		private const uint HierarchicalDirtyMask = 1 << HierarchicalDirtyOffset;
		...
		private const uint FlagsGraphMask = (256u-1) << FlagsGraphOffset;
		...
		private const uint FlagsTagMask = (32-1) << FlagsTagOffset;
