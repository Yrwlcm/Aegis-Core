...
namespace Pathfinding {
	...
	public class EditorBase : Editor {
		private static System.Collections.Generic.Dictionary<string, string> cachedTooltips;
		private static System.Collections.Generic.Dictionary<string, string> cachedURLs;
		private Dictionary<string, SerializedProperty> props = new Dictionary<string, SerializedProperty>();
		private Dictionary<string, string> localTooltips = new Dictionary<string, string>();

		private static GUIContent content = new GUIContent();
		private static GUIContent showInDocContent = new GUIContent("Show in online documentation", "");
		...
		private static string FindURL (System.Type type, string path) {
