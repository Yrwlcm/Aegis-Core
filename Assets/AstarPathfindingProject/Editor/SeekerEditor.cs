...
namespace Pathfinding {
	...
	public class SeekerEditor : EditorBase {
		private static bool tagPenaltiesOpen;
		private static List<Seeker> scripts = new List<Seeker>();

		private GUIContent[] exactnessLabels = new [] { new GUIContent("Node Center (Snap To Node)"), new GUIContent("Original"), new GUIContent("Interpolate (deprecated)"), new GUIContent("Closest On Node Surface"), new GUIContent("Node Connection") };
		private string[] graphLabels = new string[32];
