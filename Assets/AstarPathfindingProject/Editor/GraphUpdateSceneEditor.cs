...
namespace Pathfinding {
	...
	public class GraphUpdateSceneEditor : EditorBase {
		...
		private const float pointGizmosRadius = 0.09F;
		private static Color PointColor = new Color(1, 0.36F, 0, 0.6F);
		private static Color PointSelectedColor = new Color(1, 0.24F, 0, 1.0F);

		private GraphUpdateScene[] scripts;
		...
		private void DrawWalkableField () {
		...
		private static void SphereCap (int controlID, Vector3 position, Quaternion rotation, float size) {
